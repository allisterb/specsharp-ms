...
namespace System.Compiler{
  ...
  public class AssemblyNode : Module{ //An assembly is a module with a strong name
    ...
    internal PostAssemblyLoadProcessor GetAfterAssemblyLoad()
    {
    ...
    public AssemblyReference(string assemblyStrongName)
      ...
      while (i < n){
        ...
        switch (assemblyStrongName[i]){
          ...
          case 'c': case 'C': culture = ParseAssignment(assemblyStrongName, "Culture", ref i); break;
          case 'p': case 'P':
...
#endif
  {
    ...
    public virtual InterfaceList Interfaces {
      get { if (this.interfaces == null) { this.interfaces = new InterfaceList(0);} return this.interfaces; }
  ...
  protected internal virtual void ApplyOutOfBandContracts(){
    ...
    protected virtual void CopyContractToMethod(Method/*!*/ contractMethod, Method/*!*/ codeMethod) {
      ...
      for (int a = 0, n = contractMethod.ReturnAttributes == null ? 0 : contractMethod.ReturnAttributes.Count; a < n; a++) {
   ...
   internal TrivialHashtableUsingWeakReferences structurallyEquivalentMethod;
    ...
    public virtual TypeNode/*!*/ GetGenericTemplateInstance(Module/*!*/ module, TypeNodeList/*!*/ consolidatedArguments) {
      ...
      if (nestedType == null) {
        ...
        Specializer specializer = new Specializer(module, declaringTypeTemplate.ConsolidatedTemplateParameters, declaringType.ConsolidatedTemplateArguments);
  ...
  public abstract class Requires : MethodContractElement {
    public Expression Condition;
    public virtual bool IsWithException { get { return false; } }
    protected Requires()
  ...
  public class RequiresPlain : Requires {
    ...
    public override bool IsWithException
    {
      get { return this.ExceptionType != null; }
    }
  ...
  public class MethodContract : Node{
    ...
    /// <summary>
    /// Used when contract are extracted from code and the contract use delegates with closure objects
    /// </summary>
    ...
    public Block ContractInitializer
    {
      get
      {
        // materialize contract if this is an instance
        if (contractInitializer == null) SpecializeContract();
...
#if false
    public Block ContractLocalsInitializer
    {
      get
      {
        // materialize contract if this is an instance
        if (contractLocalsInitializer == null) SpecializeContract();
        return contractLocalsInitializer;
      }
      set
      {
        this.contractLocalsInitializer = value;
      }
    }
#endif
    private void SpecializeContract()
    {
      if (this.Specializer == null) return;
      if (this.DeclaringMethod == null) return;
      Method template = this.DeclaringMethod.Template;
      if (template == null) return;

      this.CopyFrom(template.Contract);
      this.contractInitializer = (Block)this.Specializer(this.DeclaringMethod, this.contractInitializer);
  ...
  public class ModelfieldContract : Node {
      ...
      : base(NodeType.ModelfieldContract)
    {
      ...
      if (declaringType is Class) {
        this.mf = new Field(declaringType, attrs, FieldFlags.Public, name, type, null); //note: if the modelfield has an override modifier, then mf is a placeholder. This will be signalled by a 'Private' flag.        
        ...
        for (int i = 0, j = 0; i < nrOfAttrs; i++) {          
          Identifier attrI = (attrs[i].Constructor as Identifier); //seems we need a HACK: Constructor has not been processed yet (by Looker).
  ...
  public class Method : Member{
    ...
    public virtual MethodContract/*?*/ Contract {
      get {
        if (contract != null) return contract == Method.DummyContract ? null : contract;
        // There may be serialized contracts in the method's attributes.
        MethodContract mc = new MethodContract(this);
        // Pull on the properties to see if anything shows up
        int count = mc.Requires.Count;
        count += mc.Ensures.Count;
        count += mc.Modifies.Count;
        count += (mc.IsPure) ? 1 : 0;
        if (0 < count) { contract = mc; return contract; } else { contract = Method.DummyContract; return null; }
      }
      set {
        contract = value;
        if (value != null) {
