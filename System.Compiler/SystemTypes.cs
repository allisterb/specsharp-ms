...
namespace System.Compiler{
  ...
  sealed class TargetPlatform{
    ...
    public static void ResetCci(string platformAssembliesLocation, Version targetVersion, bool doNotLockFile, bool getDebugInfo) {
      ...
      //Force Initialize to reload the SystemAssembly
      if (SystemTypes.SystemAssembly != null) {
          SystemTypes.SystemAssembly.Dispose();
          SystemTypes.SystemAssembly = null;
      }
  ...
  sealed class CoreSystemTypes{
    ...
    private static AssemblyNode/*!*/ GetSystemAssembly(bool doNotLockFile, bool getDebugInfo) {
      ...
      if (SystemAssemblyLocation.Location == null || SystemAssemblyLocation.Location.Length == 0)
        SystemAssemblyLocation.Location = typeof(object).Module.Assembly.Location;
      result = (AssemblyNode)(new Reader(SystemAssemblyLocation.Location, SystemAssemblyLocation.SystemAssemblyCache, doNotLockFile, getDebugInfo, true, false)).ReadModule();
